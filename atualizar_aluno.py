...
payload={
    "name": "opcional atualizar o nome.",
    "email": "opcional atualizar o email.",    
    "class_id": "Opcional atualizar a turma.",
    "external_id": "seria opcional, mas para o meu projeto será a matrícula do aluno.",
